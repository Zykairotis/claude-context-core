...
DROP TRIGGER IF EXISTS datasets_stats_trigger_insert ON claude_context.datasets;
CREATE TRIGGER datasets_stats_trigger_insert
  AFTER INSERT ON claude_context.datasets
  FOR EACH ROW
  EXECUTE FUNCTION notify_stats_update();

DROP TRIGGER IF EXISTS datasets_stats_trigger_delete ON claude_context.datasets;
CREATE TRIGGER datasets_stats_trigger_delete
  AFTER DELETE ON claude_context.datasets
  FOR EACH ROW
  EXECUTE FUNCTION notify_stats_update();

DROP TRIGGER IF EXISTS datasets_stats_trigger_update ON claude_context.datasets;
CREATE TRIGGER datasets_stats_trigger_update
  AFTER UPDATE ON claude_context.datasets
  FOR EACH ROW
  WHEN (
...
DROP TRIGGER IF EXISTS projects_stats_trigger_insert ON claude_context.projects;
CREATE TRIGGER projects_stats_trigger_insert
  AFTER INSERT ON claude_context.projects
  FOR EACH ROW
  EXECUTE FUNCTION notify_stats_update();

DROP TRIGGER IF EXISTS projects_stats_trigger_delete ON claude_context.projects;
CREATE TRIGGER projects_stats_trigger_delete
  AFTER DELETE ON claude_context.projects
  FOR EACH ROW
  EXECUTE FUNCTION notify_stats_update();

DROP TRIGGER IF EXISTS projects_stats_trigger_update ON claude_context.projects;
CREATE TRIGGER projects_stats_trigger_update
  AFTER UPDATE ON claude_context.projects
  FOR EACH ROW
