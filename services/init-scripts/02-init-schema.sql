-- Comprehensive schema for Claude Context middleware
-- Creates core relational tables expected by the API server and helpers

-- Ensure required extensions are available
CREATE EXTENSION IF NOT EXISTS pgcrypto;

-- Guarantee schema exists and becomes default search path
...
-- Projects represent isolated knowledge islands
...
-- Datasets belong to projects and provide scope boundaries
...
-- Documents capture repository/file content ingested for a dataset
...
-- Web pages store crawl content associated with a dataset
...
-- Chunks represent atomic retrieval units linked to documents or web pages
...
-- Crawl sessions track ingestion activity for monitoring
...
-- Seed initial default project for development environments
...
DO $$
BEGIN
  RAISE NOTICE '✅ Core relational schema initialized for Claude Context';
END $$;
